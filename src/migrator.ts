 ...
 *
 * For this service point 3 is the sharp one. `orders_listing_uniq` and `orders_partition` are the
 * two constraints that make "sold twice" and "the money does not add up" unrepresentable. A
 * service that could create them at boot is a service that could start without them.
 */
